/**
 * Get ARC200 FINITE (app 3211805086) balance for shelly-main via AssetMCP.
 * Run from repo root: node examples/arc200-finite-balance.mjs
 */
...
const ARC200_FINITE_APP_ID = 3211805086;
...
const metaRes = await client.callTool({
  ...
  arguments: { network: "algorand-mainnet", appId: ARC200_FINITE_APP_ID },
});
const balanceRes = await client.callTool({
  name: "arc200_balance_of",
  arguments: {
    network: "algorand-mainnet",
    appId: ARC200_FINITE_APP_ID,
    address: SHELLY_MAIN,
  },
});
...
console.log("ARC200 FINITE (app", ARC200_FINITE_APP_ID + ")");
